...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.radio_metaDestinoAtual, 0, 4, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.frame_15, 0, 5, 1, 1)
        ...
        self.inputCheck_atualizadoSistema.setFont(font4)

        self.horizontalLayout_3.addWidget(self.inputCheck_atualizadoSistema)


        self.gridLayout.addWidget(self.frame_13, 5, 2, 1, 4)
...
"}")
        ...
        self.gridLayout.addWidget(self.frame_17, 4, 2, 1, 4)
        ...
        self.gridLayout.addWidget(self.radio_metaOrigemAtual, 0, 0, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.frame_20, 1, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.radio_metaSuplementadoOrigem, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.radio_metaSuplementadoDestino, 1, 4, 1, 1)
